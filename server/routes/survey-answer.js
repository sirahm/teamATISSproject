...
router.get('/', requireAuth, (req, res, next) => {
    Survey.find((err, surveyAnswers) => {
        ...
        res.render('survey', { title: 'Survey Table', SurveyList: surveyAnswers, displayName: (0, Util_1.UserDisplayName)(req) });
    });
});

// GET the Book Details page in order to add a new Book
router.get('/add', requireAuth, (req, res, next) => {
    res.render('edit', { title: 'Add Survey', SurveyList: {}, displayName: (0, Util_1.UserDisplayName)(req) });
});
...
router.get('/edit/:id', requireAuth, (req, res, next) => {
    ...
    Survey.findById(id, (err, surveyToEdit) => {
        ...
        //show the edit view
        res.render('edit', { title: 'Edit Survey', SurveyList: surveyToEdit, displayName: (0, Util_1.UserDisplayName)(req) });
    });
});
